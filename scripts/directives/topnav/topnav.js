...
angular.module('dashyAngular').directive(
		'topnav',
		function() {
			return {
				templateUrl : 'scripts/directives/topnav/topnav.html?v='
						+ window.app_version,
				restrict : 'E',
				replace : true,
				controller : function($scope, $rootScope, AuthEG) {
					...
					$scope.$watch('val', function() {
						...
						localStorage.setItem("switched", JSON
								.stringify($scope.val));
					});
