					...
					return {
						...
						link : function(scope, elem, attrs, ctrl) {
							scope.$watch('password', function(newVal) {
								...
								scope.strength = isSatisfied(newVal
										&& newVal.length >= 8)
										+ isSatisfied(newVal
												&& /[A-z]/.test(newVal))
										+ isSatisfied(newVal
						...
						template : '<div class="pass-progress">'
			...
			return {
				...
				link : function(scope, elem, attrs, ctrl) {
					ctrl.$parsers.unshift(function(viewValue) {
						...
						// angular does this with all validators -> return
						// isValid ? viewValue : undefined;
						// But it means that the ng-model will have a value of
						// undefined
