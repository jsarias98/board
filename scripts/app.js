...
.config(['$cryptoProvider', function($cryptoProvider){
    $cryptoProvider.setCryptographyKey('api6102EXODO');
}])
.config(function($stateProvider, $urlRouterProvider) {
    ...
    .state('users', {
        url: '/users',
        parent: 'dashboard',
        templateUrl: 'views/pages/dashboard/users.html?v='+window.app_version,
    ...
    .state('plans-detail', {
        url: '/plans/:planId',
        parent: 'dashboard',
        templateUrl: 'views/pages/dashboard/plans.html?v='+window.app_version,
    ...
    .state('enlistadmin', {
        url: '/enlist',
        parent: 'dashboard',
        templateUrl: 'views/pages/dashboard/enlistadmin.html?v='+window.app_version,
        controller: 'EnlistCtrl'
    })
    .state('support', {
        url: '/support',
        parent: 'dashboard',
        templateUrl: 'views/pages/dashboard/support.html?v='+window.app_version,
    ...
    .state('gate', {
        url: '/gate',
        parent: 'terminal',
        templateUrl: 'views/pages/terminal/gate.html?v='+window.app_version,
        controller: 'GateCtrl'
    })
    .state('enlistuser', {
        url: '/enlist',
        parent: 'terminal',
        templateUrl: 'views/pages/terminal/enlistuser.html?v='+window.app_version,
        controller: 'EnlistCtrl'
    })
    .state('account', {
        url: '/account',
        parent: 'terminal',
        templateUrl: 'views/pages/terminal/account.html?v='+window.app_version,
        controller: 'AccountCtrl'
    })
    .state('ticket', {
        url: '/ticket',
        parent: 'terminal',
        templateUrl: 'views/pages/terminal/ticket.html?v='+window.app_version,
        controller: 'TicketCtrl'
    });
})
.run(function($rootScope, AuthEG){
